    ...
    if(isset($_POST['themphanhoi'])){
        if(isset($_SESSION['makh'])){
            ...
            if($_POST['noidung'] != ""){
                ...
                $comment = $c_TraSua->themphanhoi($makh,$noidung);
             ...
             $_SESSION['chuadangnhap']= "Vui lòng đăng nhập để thêm phản hồi";
        }
    }
...
<body>
    ...
    <div class="product-big-title-area">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <h2 style="font-family: 'segoe ui light',sans-serif;">Liên hệ với Kimochi</h2>
                    </div>
                </div>
            </div>
        </div>
     ...
     <!-- End Page title area -->
        <div class="container">
               <p class="edit">KIMOCHI luôn mong muốn nhận được nhưng phản hồi quý giá của quý khách hàng để có cơ hội hoàn thiện sản phẩm, dịch vụ hơn nữa. Những đóng góp của quý khách hàng luôn là tài sản vô giá đối với chúng tôi</p>
                <hr>
            

                        <h3>THỎA THUẬN BẢO MẬT THÔNG TIN</h3>
                        <ul>
                            <p>1. KIMOCHI sẽ luôn giữ bí mật các thông tin của khách hàng và tuân thủ những quy định pháp luật về bảo mật thông tin có liên quan.</p>
                            <p>
                                2. KIMOCHI có thể tiết lộ thông tin cá nhân cho mục đích giải quyết khiếu nại, than phiền của khách hàng cho:</p>
                                <p>- Các bộ phận trực thuộc KIMOCHI Việt Nam;</p>
                                <p>- Bên thứ ba được ủy quyền chính thức từ KIMOCHI Việt Nam cho việc giải quyết các than phiền, khiếu nại mang tính chất nghiêm trọng.</p>
                           
                        </ul>
                        <ul><h3 class ="text text-danger"> Hot lines :</h3>
                            <li>SDT : 01249090102</li>
                            <li>Email : KimochiMilkTea@gmail.com</li>
                        </ul>
                     <hr>
                        <?php
                        ...
                        ?>
                     <div class="well">
                            <h5>Gửi phản hồi của bạn cho Kimochi<span class="glyphicon glyphicon-pencil"></span></h5>
                            <form role="form" action="#" method="post">
                                <input type="hidden" name="mahh" value="">
                                <div class="form-group">
                                    <textarea class="form-control" rows="3" name="noidung"></textarea>
                                </div>
                                <button type="submit" class="btn btn-primary" name="themphanhoi">Gửi</button>
                            </form>
                        </div>
                         <?php
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul>
                            ...
                            <li><a href="contact.html">Liên hệ nhà cung cấp</a></li>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul>
                            <li><a href="shop.html">Trà sữa</a></li>
                        </ul>                        
                    </div>
                </div>
                    ...
                    <div class="footer-newsletter">
                        ...
                        <div class="newsletter-form">
                            <form action="#">
                                ...
                                <input type="submit" value="Đăng kí" id="thongBao" onclick="showAlert()">
                            </form>
                        </div>
                    </div>
                </div>
